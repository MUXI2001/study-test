...
def main(num_epoch, disc_lr, gene_lr):
    ...
    disc_model.add(layers.Dense(12, use_bias=True, activation='relu', input_shape=(4,), kernel_regularizer=tf.keras.regularizers.L2(0.00001)))
    ...
    for i in range(num_epoch):
        ...
        with tf.GradientTape() as tape:
            ...
            gene_loss, er, er2 = generator_loss(fake_preds, fake_trajectory[:, 0:4], label[:, 0:4], beta, 0.82)
